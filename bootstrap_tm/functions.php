...
//-------------
  ...
  //allows us to create a custom menu-types on the backend that will also show on the frontend
  //  --- accessed as `wp_nav_menu(...)`
  ...
  create_widget('Footer Company', 'footer-company', 'Displays company in the footer');
  create_widget('Footer Nav-Menu', 'footer-nav', 'Displays navigation in the footer');
